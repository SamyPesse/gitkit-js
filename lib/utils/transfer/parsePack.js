...
function parseInflateContent(parser) {
    ...
    // Index the content inflated for this specific index
    .tap(function() {
        this.gitContentIndex = this.gitContentIndex || {};
        this.gitContentIndex[baseOffset] = this.vars.content;
    });
}
...
function parseOFSDeltaHeader(parser) {
    ...
    .tap(function() {
        ...
        console.log('ref offset is', offset);
    });
}
    ...
    .tap(function() {
        ...
        this.loop(function(endObjectLoop) {
            ...
            .tap(function() {
                ...
                console.log('-> sha:', objOffset, objectType, obj.getSha());
                //console.log('');
                this.emit('data', obj);
